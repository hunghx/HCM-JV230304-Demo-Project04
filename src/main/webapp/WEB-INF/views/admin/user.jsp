                        ...
                        <table id="example1" class="table table-bordered table-striped text-center">
                            ...
                            <c:forEach items="${users}" var="user">
                                <tr>
                                    <td>${user.userId}</td>
                                    <td>${user.username}</td>
                                    <td><img width="40%" src="${user.avatar}" alt="avt"></td>
                                    <td>${user.fullName}</td>
                    ...
                    <nav aria-label="Page navigation example ">
                        <ul class="pagination float-end mx-4">
                            <li class="page-item ${page==0?'disabled':''}">
                                <a class="page-link" href="/admin/user?page=${page+-1}&keyword=${keyword}">Previous</a>
                            </li>
<%--                            <li class="page-item active"><a class="page-link" href="#">1</a></li>--%>
<%--                            <li class="page-item"><a class="page-link" href="#">2</a></li>--%>
<%--                            <li class="page-item"><a class="page-link" href="#">3</a></li>--%>
                            <c:forEach begin="0" end="${totalPages-1}" step="1" varStatus="loop">
                                <li class="page-item ${loop.current == page?'active':''}"><a class="page-link" href="/admin/user?page=${loop.current}&keyword=${keyword}">${loop.count}</a></li>
                            </c:forEach>
                            <li class="page-item ${page+1==totalPages?'disabled':''}">
                                <a class="page-link" href="/admin/user?page=${page+1}&keyword=${keyword}">Next</a>
                            </li>
                        </ul>
                    </nav>
                    <!-- /.card-body -->
